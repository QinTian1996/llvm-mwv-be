//===-- Mwv208MCInstLower.cpp - Convert Mwv208 MachineInstr to MCInst
//-------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains code to lower Mwv208 MachineInstrs to their corresponding
// MCInst records.
//
//===----------------------------------------------------------------------===//
...
static MCOperand LowerSymbolOperand(const MachineInstr *MI,
  ...
  Mwv208MCExpr::VariantKind Kind =
      (Mwv208MCExpr::VariantKind)MO.getTargetFlags();
  ...
  const Mwv208MCExpr *expr = Mwv208MCExpr::create(Kind, MCSym, AP.OutContext);
...
void llvm::LowerMwv208MachineInstrToMCInst(const MachineInstr *MI,
